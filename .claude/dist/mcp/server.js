...
function registerTools(server, db) {
  server.registerTool(
    "db_query",
    {
      ...
      inputSchema: {
        sql: external_exports.string().describe("\uC2E4\uD589\uD560 SQL SELECT \uBB38")
      }
    },
    ({ sql }) => {
      if (!sql.trim().toUpperCase().startsWith("SELECT")) {
        return {
          content: [{ type: "text", text: "Error: SELECT \uCFFC\uB9AC\uB9CC \uD5C8\uC6A9\uB429\uB2C8\uB2E4." }],
          isError: true
        };
      }
      try {
  ...
  server.registerTool(
    "task_list",
    {
      ...
      inputSchema: {
        status: external_exports.enum(["pending", "in_progress", "done", "all"]).optional().describe("\uD544\uD130\uB9C1\uD560 \uD0DC\uC2A4\uD06C \uC0C1\uD0DC (\uBBF8\uC9C0\uC815 \uC2DC pending)")
      }
    },
    ({ status }) => {
      try {
  ...
  server.registerTool(
    "task_add",
    {
      ...
      inputSchema: {
        description: external_exports.string().describe("\uD0DC\uC2A4\uD06C \uC124\uBA85"),
        priority: external_exports.number().int().min(1).max(5).optional().describe("\uC6B0\uC120\uC21C\uC704 1(\uB192\uC74C)~5(\uB0AE\uC74C), \uAE30\uBCF8\uAC12 3"),
        category: external_exports.string().optional().describe("\uD0DC\uC2A4\uD06C \uCE74\uD14C\uACE0\uB9AC")
      }
    },
  ...
  server.registerTool(
    "decision_add",
    {
      ...
      inputSchema: {
        description: external_exports.string().describe("\uACB0\uC815 \uB0B4\uC6A9"),
        rationale: external_exports.string().optional().describe("\uACB0\uC815 \uC774\uC720/\uADFC\uAC70")
      }
    },
  ...
  server.registerTool(
    "live_get",
    {
      ...
      inputSchema: {
        key: external_exports.string().describe("\uC870\uD68C\uD560 \uCEE8\uD14D\uC2A4\uD2B8 \uD0A4")
      }
    },
    ({ key }) => {
      try {
  ...
  server.registerTool(
    "live_set",
    {
      ...
      inputSchema: {
        key: external_exports.string().describe("\uC800\uC7A5\uD560 \uCEE8\uD14D\uC2A4\uD2B8 \uD0A4"),
        value: external_exports.string().describe("\uC800\uC7A5\uD560 \uAC12")
      }
    },
    ({ key, value }) => {
      try {
  ...
  server.registerTool(
    "team_dispatch",
    {
      ...
      inputSchema: {
        worker_name: external_exports.string().describe("\uC6CC\uCEE4 \uC5D0\uC774\uC804\uD2B8 \uC774\uB984 (\uC608: ralph, verifier)"),
        task_description: external_exports.string().describe("\uC6CC\uCEE4\uC5D0\uAC8C \uC804\uB2EC\uD560 \uD0DC\uC2A4\uD06C \uB0B4\uC6A9"),
        priority: external_exports.number().int().min(1).max(5).optional().describe("\uC6B0\uC120\uC21C\uC704 1(\uB192\uC74C)~5(\uB0AE\uC74C), \uAE30\uBCF8\uAC12 3")
      }
    },
  ...
  server.registerTool(
    "team_status",
    {
      ...
      inputSchema: {
        worker_name: external_exports.string().optional().describe("\uD2B9\uC815 \uC6CC\uCEE4 \uC774\uB984 (\uBBF8\uC9C0\uC815 \uC2DC \uC804\uCCB4)")
      }
    },
    ({ worker_name }) => {
      try {
        const allContext = db.liveDump();
        const agentKeys = Object.entries(allContext).filter(
          ([k]) => k.startsWith("_task:")
        );
        if (worker_name) {
          ...
          const status = result ? "done" : task ? "in_progress" : "no_task";
          return {
            content: [
              {
                type: "text",
  ...
  server.registerTool(
    "team_result",
    {
      ...
      inputSchema: {
        worker_name: external_exports.string().describe("\uACB0\uACFC\uB97C \uC870\uD68C\uD560 \uC6CC\uCEE4 \uC5D0\uC774\uC804\uD2B8 \uC774\uB984")
      }
    },
    ({ worker_name }) => {
      try {
        ...
        return {
          content: [
            {
              type: "text",
              text: result !== null ? result : `(null \u2014 ${worker_name}\uC758 \uACB0\uACFC\uAC00 \uC544\uC9C1 \uC5C6\uC74C)`
            }
          ]
        };
      } catch (err) {
  ...
  server.registerTool(
    "team_context",
    {
      description: "\uD300 \uACF5\uC720 \uCEE8\uD14D\uC2A4\uD2B8\uB97C \uC77D\uAC70\uB098 \uC4F4\uB2E4. value \uBBF8\uC9C0\uC815 \uC2DC \uC870\uD68C, \uC9C0\uC815 \uC2DC \uC800\uC7A5. helper.sh agent-context\uC640 \uB3D9\uB4F1.",
      inputSchema: {
        key: external_exports.string().describe("\uCEE8\uD14D\uC2A4\uD2B8 \uD0A4"),
        value: external_exports.string().optional().describe("\uC800\uC7A5\uD560 \uAC12 (\uBBF8\uC9C0\uC815 \uC2DC \uC77D\uAE30 \uBAA8\uB4DC)")
      }
    },
    ({ key, value }) => {
      try {
        if (value !== void 0) {
          ...
          return {
            content: [
              {
                type: "text",
                text: result !== null ? result : `(null \u2014 \uD0A4 '${key}'\uAC00 \uC874\uC7AC\uD558\uC9C0 \uC54A\uC74C)`
              }
            ]
          };
        }
...
function findProjectRoot() {
  ...
  let dir = process.cwd();
  for (let i = 0; i < 8; i++) {
    if (existsSync(join2(dir, ".claude", "db", "context.db"))) {
      return dir;
    }
  ...
  let fileDir = __dirname2;
  for (let i = 0; i < 6; i++) {
    if (existsSync(join2(fileDir, ".claude"))) {
      return fileDir;
    }
    const parent = dirname2(fileDir);
...
async function main() {
  ...
  const dbPath = join2(projectRoot, ".claude", "db", "context.db");
  let db;
  try {
